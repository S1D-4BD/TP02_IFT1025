...
public class ReplayController extends ControllerBase {
    ...
    private void goBackward() {
        ...
        //int longueurJeu = encounters.length; //la longueur max du jeu
        //si on est PAS au debut du cheminjusquaboss, alors on peut reculer et show ce qui sy passe
        if (currentIndex > 0) {
            currentIndex--;
            showCurrentMessageAndImage(); 
        }else
        {
            System.out.println("On est deja au debut");
        }
    }
    ...
    private void goForward() {
        ...
        int longueurJeu =encounters.length; //la longueur max du jeu
        //si on est PAS a la fin du cheminjusquaboss, alors on peut aller de l avant et show ce qui sy passe
        if (currentIndex < longueurJeu - 1) {
            currentIndex++;
            showCurrentMessageAndImage();
        }else
        {
            System.out.println("On est a la fin deja");
        }
